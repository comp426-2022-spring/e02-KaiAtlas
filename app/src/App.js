...
let sum = parseInt(currentA00) + parseInt(currentA01) + parseInt(currentA02)+ parseInt(currentA03) + parseInt(currentA04)+ parseInt(currentA05) + parseInt(currentMidterm) + parseInt(currentFinal)+ parseInt(currentCommits)+ parseInt(currentE01) + parseInt(currentE02) ;
    setCurrentSum(sum);
  }
